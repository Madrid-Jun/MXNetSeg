...
class MapillarySegmentation(SegmentationDataset):
    ...
    Reference: [1] G. Neuhold, T. Ollmann, S. R. Bulo, and P. Kontschieder, “The Mapillary
    ...
    def __init__(self, root=os.path.expanduser('~/.mxnet/datasets/mapillary'), split='train',
