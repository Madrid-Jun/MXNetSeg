...
class AeroSegmentation(SegmentationDataset):
    """
    Nigam, Ishan, Chen Huang, and Deva Ramanan. "Ensemble knowledge transfer for semantic segmentation."
    2018 IEEE Winter Conference on Applications of Computer Vision (WACV). IEEE, 2018.
    """

    NUM_CLASS = 11

    def __init__(self, root=os.path.expanduser('~/.mxnet/dataset/Aeroscapes'), split='train',
                 mode=None, transform=None, **kwargs):
        super(AeroSegmentation, self).__init__(root, split, mode, transform, **kwargs)
